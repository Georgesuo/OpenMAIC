  ...
  'edge-tts': {
    ...
    voices: [
      ...
      },
      {
        ...
        language: 'zh-CN',
        gender: 'female',
        description: 'edgeVoiceXiaoshuang',
      },
      {
