export const settingsZhCN = {
  settings: {
    ...
    // Edge TTS Voice descriptions
    edgeVoiceXiaoxiao: '晓晓 - 温柔女声，适合多种场景',
    edgeVoiceYunxi: '云希 - 阳光男声，富有活力',
    edgeVoiceXiaoyi: '晓伊 - 甜美女声，亲切自然',
    edgeVoiceYunjian: '云健 - 沉稳男声，专业大气',
    edgeVoiceXiaochen: '晓晨 - 清亮女声，适合新闻播报',
    edgeVoiceXiaohan: '晓涵 - 温婉女声，富有感染力',
    edgeVoiceXiaomeng: '晓梦 - 梦幻女声，适合故事讲述',
    edgeVoiceXiaomo: '晓墨 - 知性女声，适合教育场景',
    edgeVoiceXiaorui: '晓睿 - 智慧女声，适合商务场景',
    edgeVoiceXiaoshuang: '晓双 - 双语女声，适合中英混合',
    edgeVoiceXiaoxuan: '晓萱 - 活泼女声，富有朝气',
    edgeVoiceXiaoyan: '晓颜 - 端庄女声，适合正式场合',
    edgeVoiceXiaoyou: '晓悠 - 悠扬女声，适合轻松场景',
    edgeVoiceYunfeng: '云枫 - 成熟男声，富有磁性',
    edgeVoiceYunhao: '云皓 - 清朗男声，适合解说',
    edgeVoiceYunxia: '云夏 - 夏日男声，清新自然',
    edgeVoiceYunye: '云野 - 旷野男声，富有张力',
    edgeVoiceYunze: '云泽 - 深沉男声，适合旁白',
    edgeVoiceJenny: 'Jenny - 美式女声，自然流畅',
    edgeVoiceGuy: 'Guy - 美式男声，富有感染力',
    edgeVoiceAria: 'Aria - 美式女声，适合对话',
    edgeVoiceDavis: 'Davis - 美式男声，专业稳重',
    edgeVoiceNanami: '七海 - 日语女声，温柔甜美',
    edgeVoiceKeita: '圭太 - 日语男声，阳光帅气',
    edgeVoiceSunHi: '선미 - 韩语女声，温柔亲切',
    edgeVoiceInJoon: '인준 - 韩语男声，沉稳大气',
...
export const settingsEnUS = {
  settings: {
    ...
    providerEdgeTTS: 'Edge TTS (Microsoft Free)',
    ...
    // Edge TTS Voice descriptions
    edgeVoiceXiaoxiao: 'Xiaoxiao - Gentle female voice, versatile',
    edgeVoiceYunxi: 'Yunxi - Sunny male voice, energetic',
    edgeVoiceXiaoyi: 'Xiaoyi - Sweet female voice, friendly',
    edgeVoiceYunjian: 'Yunjian - Steady male voice, professional',
    edgeVoiceXiaochen: 'Xiaochen - Clear female voice, news broadcasting',
    edgeVoiceXiaohan: 'Xiaohan - Graceful female voice, expressive',
    edgeVoiceXiaomeng: 'Xiaomeng - Dreamy female voice, storytelling',
    edgeVoiceXiaomo: 'Xiaomo - Intellectual female voice, educational',
    edgeVoiceXiaorui: 'Xiaorui - Wise female voice, business',
    edgeVoiceXiaoshuang: 'Xiaoshuang - Bilingual female voice, mixed Chinese-English',
    edgeVoiceXiaoxuan: 'Xiaoxuan - Lively female voice, energetic',
    edgeVoiceXiaoyan: 'Xiaoyan - Dignified female voice, formal occasions',
    edgeVoiceXiaoyou: 'Xiaoyou - Melodious female voice, relaxed scenes',
    edgeVoiceYunfeng: 'Yunfeng - Mature male voice, magnetic',
    edgeVoiceYunhao: 'Yunhao - Clear male voice, narration',
    edgeVoiceYunxia: 'Yunxia - Summer male voice, fresh',
    edgeVoiceYunye: 'Yunye - Wild male voice, powerful',
    edgeVoiceYunze: 'Yunze - Deep male voice, narration',
    edgeVoiceJenny: 'Jenny - American female voice, natural and smooth',
    edgeVoiceGuy: 'Guy - American male voice, expressive',
    edgeVoiceAria: 'Aria - American female voice, conversational',
    edgeVoiceDavis: 'Davis - American male voice, professional and steady',
    edgeVoiceNanami: 'Nanami - Japanese female voice, gentle and sweet',
    edgeVoiceKeita: 'Keita - Japanese male voice, sunny and handsome',
    edgeVoiceSunHi: '선미 - Korean female voice, gentle and friendly',
    edgeVoiceInJoon: '인준 - Korean male voice, steady and dignified',
    // ASR Language names (native forms - autoglossonyms)
